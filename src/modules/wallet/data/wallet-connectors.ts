import { WalletConnector, WalletName } from '../@types';
...
export const WEB_WALLET_NAMES = [WalletName.STASHED];

export const WALLET_LOGO_MAP: Record<string, WalletConnector['iconUrl']> = {
  [WalletName.SUI_WALLET]:
...
export const WALLET_DOWNLOAD_URLS_MAP: Record<
  string,
  WalletConnector['downloadUrls']
> = {
  [WalletName.SUI_WALLET]: {
